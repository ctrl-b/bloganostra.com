...
module Jekyll
  ...
  module Filters
    ...
    if pager['previous_page'] || pager['next_page']
      ...
      if pager['next_page'] 
        html << "<a class=\"prev\" href=\"/#{pager['category']}/page#{pager['next_page']}\" title=\"Older posts\"><i class=\"icon-left-circled\"></i></a>"
      end

      if pager['previous_page']
        
        if pager['previous_page'] == 1
          html << "<a class=\"next\" href=\"/#{pager['category']}/\" title=\"Newer posts\"><i class=\"icon-right-circled\"></i></a>"
        else
          html << "<a class=\"next\" href=\"/#{pager['category']}/page#{pager['previous_page']}\" title=\"Newer posts\"><i class=\"icon-right-circled\"></i></a></i>"
        end
